    ...
    public partial class FormDiem : Form
    {
        ...
        private void dataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == dataGridView.Columns["ActionButton"].Index && e.RowIndex >= 0)
            {
                ...
                // Lấy dữ liệu từ các ô phía trước nút
                ...
                // Tạo và mở DetailsForm
                ChiTietDiem chiTietDiem = new ChiTietDiem(itenLopHoc, itenMonHoc, itenHinhThuc, itenGiaoVien, tenLopHoc, tenMonHoc, tenHinhThuc, soBuoi, tenGiaoVien, id);
                chiTietDiem.ShowDialog(); // Sử dụng ShowDialog để mở form theo chế độ modal
            }
        }
